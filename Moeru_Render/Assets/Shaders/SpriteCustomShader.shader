Shader "Custom/Sprite Custom Shader"
{
    Properties
    {
        ...
        [PerRenderData] _AlphaTex ("Alpha Texture", 2D) = "white" {}
        [PerRenderData] _EnvLut ("Environment LUT", 2D) = "white" {}
        _ColorScale ("Color Scale", Float) = 0.0
        _Color ("Tint", Color) = (1,1,1,1)
        _CustomType("Custom Type", Int) = 1
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if ( _CustomType == 2){
                    ...
                    float newR = (c.r *256 + bCol * 256) / 1024.0f;
                    float newG = (c.g *256 + bRow * 256) / 1024.0f;
